...
namespace UnityQuickSheet
{
    ...
    public class BaseMachineEditor : Editor
    {
        ...
        {
            sp.className = machine.prefixString + machine.WorkSheetName;
            sp.dataClassName = machine.prefixString + machine.WorkSheetName + "Data";
            sp.template = GetTemplate("ScriptableObjectClass");
            sp.dataRowStartIndex = machine.dataRowStartIndex;
        ...
        {
            sp.className = machine.prefixString + machine.WorkSheetName + "Editor";
            sp.worksheetClassName = machine.prefixString + machine.WorkSheetName;
            sp.dataClassName = machine.prefixString + machine.WorkSheetName + "Data";
        ...
        protected void CreateDataClassScript(BaseMachine machine, ScriptPrescription sp)
        {
            ...
            {
                // custom: undefined시 무시
                if (header.type == CellType.Undefined) continue;
            ...
            sp.className = machine.prefixString + machine.WorkSheetName + "Data";
        ...
        {
            return Path.Combine("Assets/" + machine.RuntimeClassPath, machine.prefixString + worksheetName + "." + "cs");
        }
        ...
        {
            return Path.Combine("Assets/" + machine.EditorClassPath, machine.prefixString + worksheetName + "Editor" + "." + "cs");
        }
        ...
        {
            return Path.Combine("Assets/" + machine.RuntimeClassPath, machine.prefixString + worksheetName + "Data" + "." + "cs");
        }
        ...
        {
            return Path.Combine("Assets/" + machine.EditorClassPath, machine.prefixString + worksheetName + "AssetCreator" + "." + "cs");
        }
        ...
        {
            return Path.Combine("Assets/" + machine.EditorClassPath, machine.prefixString + worksheetName + "AssetPostProcessor" + "." + "cs");
        }
        ...
        protected ColumnHeader ParseColumnHeader(string columnheader, int order, string typeStr = null)
        {
            ...
            if (typeStr != null)
            {
                CellType t = CellType.Undefined;
                Enum.TryParse<CellType>(typeStr, true, out t);
                return new ColumnHeader { name = cHeader, type = t, OrderNO = order };
            }
