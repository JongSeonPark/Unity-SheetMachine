...
namespace UnityQuickSheet
{
    ...
    public class BaseMachine : ScriptableObject
    {
        ...
        /// 데이터가 시작되는 Row
        /// </summary>
        public int dataRowStartIndex = 3;

        public bool isDataTypeIndex = false;
        /// <summary>
        /// 데이터 타입을 정의한 Row
        /// </summary>
        public int dataTypeIndex = 1;
        ...
        protected readonly string DEFAULT_CLASS_PATH = "Asset Packs/QuickSheet/ExcelPlugin/Runtime";
        protected readonly string DEFAULT_EDITOR_PATH = "Asset Packs/QuickSheet/ExcelPlugin/Editor";
